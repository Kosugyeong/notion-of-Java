...
public class Ex25_array {
	...
	private static void m11() {
		...
		System.out.println(dump(ns)); //[3,5,3,9,8,1,3,10,4,6,]
		
		//배열의 작업을 도와주는 클래스 > Arrays
		System.out.println(Arrays.toString(ns)); //덤프 메소드 > 배열 상태 확인용으로 사용!!! [1, 3, 4, 4, 6, 6, 7, 8, 9, 1]
	}
	...
	private static void m10() {
		...
		String[] name1 = new String[] {"홍길동", "아무개", "하하하"};
	...
	private static void m9() {
		...
		// 배열 자동 초기화
		// 배열(참조형)은 값형과 다르게 생성 직후에 사용자(개발자)가 아무것도 안해도 자동으로 초기화가 됨.
	...
	private static void m8() {
		...
		// - 주소값 복사
		// - Side Effect 발생(원본 고치면 복사본도 고쳐지고 복사본이 고쳐지면 원본도 고쳐짐)

		// 2. 깊은 복사, Deep copy => 간간히 씀.
		// - 요소끼리 복사 > 값복사
		// - Side Effect 발생 X
		...
		// int[] copy; // 얕은 복사에서 복사할 변수는 변수만 만들어도 됨.
	...
	private static void m7() {
		...
		// a안에는 데이터(값) 10이 들어있다.
		int a = 10;// 값형(공간 안에 데이터 자체가 들어있는 자료형)=Value Type
		int b;
		...
		// ns 안에는 실제 배열의 주소값이 들어있다.
		int[] ns = new int[3]; // 참조형(Reference Type)-> 주소값을 저장하는 자료형
		ns[0] = 10;
		ns[1] = 20;
		ns[2] = 30;
	...
	private static void m4() {
		...
		// 오류 > java.lang.ArrayIndexOutOfBoundsException: Index 3 out of bounds for length 3
		// 3번방은 없어요;;
		// kors[3]=70;
	...
	private static void m2() {
		...
		double avg = total / kors.length; // kor.length 배열의 길이
