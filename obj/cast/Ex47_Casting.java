...
public class Ex47_Casting {
	public static void main(String[] args) {
		...
		G102 m5 = new G102("광", 26000, 6000, "파랑");
		
		M331 m6 = new M331("광", "검정", 33000, 10000);
		M331 m7 = new M331("광", "연두", 32000, 11000);
		
		
		//각 클래스들이 가지고 있는 메소드들을 사용할거면 이와 같이 배열을 하나씩 만들어 for문 돌리는게 더 효율적인 방법일 때가 있고, 각 클래스들이 가지고 있는 공통된 메소드들만 필요하면 부모 클래스를 만들어 상속을 해 다운캐스팅을 하는게 간편할 수도 있다. 
		...
		for(int i = 0; i<mlist.length;i++) {
			...
			//	   -> 이 때 원래 자료형으로 되돌려서 고유 기능을 사용한다. > 다운 캐스팅
//			//G304 > clean()
