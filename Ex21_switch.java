...
public class Ex21_switch {
	...
	private static void m2() throws Exception {
		...
		System.out.println("-----------------");
		System.out.print("선택(번호입력): "); // 사용자가 한글로 입력하게 하지말고 숫자로 입력하게 하기!!!!

		// 이와 같은 상황에서는 String으로 숫자 받기. 수 가지고 더하기 빼기 할 일이 없으므로.
		...
		// case "1"과 case "2"는 System.out.println("700원입니다.");를 공유하고 있는 것.
		switch (sel) {
			case "1":
			case "2":
				System.out.println("700원입니다.");
