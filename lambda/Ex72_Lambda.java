...
public class Ex72_Lambda {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//Case 1. 클래스 선언 + 객체 생성 (재사용 객체)
		MyInterface m1 = new MyClass();
		m1.test();
		
		
		//Case 2. 익명 객체 생성(1회용 객체)
		...
		//Case 3. 람다식 == 메소드(*** 인터페이스로부터 상속받아 재정의한 메소드!!!) -1회용 객체
		...
		//**** 실행 블럭에 코드가 한 줄이면 {} 생략이 가능하다.
		NoParameterNoReturn pr3 = () -> System.out.println("pr3");
		pr3.call();
		
		
		
		//매개변수가 있는 익명객체를 람다식으로 호출
		//void call(int num) 
		...
		//매개변수의 자료형은 생략할 수 있지만 매개변수의 소괄호 생략은 매개변수가 1개일때만 가능하다.
		...
		//** 실행문에 return 문이 유일하면 {}과 return을 생략할 수 있다. 
