...
public class Ex65_Anonymous {
	...
	public static void main(String[] args) {
		...
		*/
		...
		//2. 부모가 인트페이스일 때 부모타입(인터페이스)으로 참조 변수 만들기 ***실무에서 보통 이 방법 씀
		//- 업캐스팅
		AAA b2 = new BBB();
		b2.aaa();
		...
		//3. 
		// AAA b3 = new AAA(); //Cannot instantiate the type AAA > 인터페이스는 객체를 못만든다.
		...
		AAA b3 = new AAA() {
			...
			//익명 객체는 자신만의 멤버를 만들지 않습니다. > 부모 인터페이스 참조 변수를 통해서 호출 불가능+ 다운 캐스팅 불가능
//			public void ccc() {
...
class BBB implements AAA {
	...
	@Override // ctrl + space로 interface가 가지고 있는 메소드 오버라이드해서 구현
	public void aaa() {
